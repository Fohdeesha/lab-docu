# H710P D1 IT Mode Flashing
Continued instructions for flashing the H710P (Note the P!) Mini Mono (D1 Revision). You should only continue here after following the [Introduction Page](perc.md). If you haven't done so already, go back.
