# H710P B0 For Blades IT Mode Flashing
Continued instructions for flashing the H710P Mini Mono (B0 Revision) for blade servers (M620 etc). You should only continue here after following the [Introduction Page](perc.md). If you haven't done so already, go back.  
