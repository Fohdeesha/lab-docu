...
Continued instructions for flashing the H810 Full Size (D1 Revision). You should only continue here after following the [Introduction Page](perc.md). If you haven't done so already, go back.
