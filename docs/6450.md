...
To begin, visit the [Brocade Overview](https://fohdeesha.com/docspriv/brocade-overview/) page, and download the firmware ZIP - this also contains the license files.
