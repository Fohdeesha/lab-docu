# H710P B0 Full Size IT Mode Flashing
Continued instructions for flashing the H710P Full Size (B0 Revision). You should only continue here after following the [Introduction Page](https://fohdeesha.com/docs/perc/). If you haven't done so already, go back.
