# H710 B0 For Blades IT Mode Flashing
Continued instructions for flashing the H710 Mini Mono (B0 Revision) for blade servers (M620 etc). You should only continue here after following the [Introduction Page](perc.md). If you haven't done so already, go back.  
...
>
>Thank you to Richard S for collecting the required files for me on his blade system!
